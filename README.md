...
After doing this project, it turns out not all ops are fully supported for each hardware target. Look [here](https://mace.readthedocs.io/en/latest/user_guide/op_lists.html) for a comprehensive list of supported operators.
...
For `shufflenet-gpu-optimized`, the OpenCL implementation lies in `mace/ops/opencl/cl/channel_shuffle.cl`.
...
Some more detailed debugging notes and results obtained are shown in [DEVELOPMENT.md](DEVELOPMENT.md).
